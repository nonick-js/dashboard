...
>({
  ...
  const currentHex = numberToHex(field.value ?? 0);
    ...
    return (
      <div {...getInnerWrapperProps()}>
        ...
        <HexColorInput
          {...getInputProps()}
          onChange={(newHex) => {
            const newValue = hexToNumber(newHex);
  ...
  }, [startContent, end, getInputProps, getInnerWrapperProps, field.onChange, currentHex]);
